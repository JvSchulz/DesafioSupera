...
public class ItemOrderController {
	...
	public ItemOrder addOrder(@PathVariable(name = "id", required = true) Long idProduct,
	...
	public void removeOrder(@PathVariable(name = "id", required = true) Long idOrder) {
		itemOrderRespository.deleteById(idOrder);
	}
}
